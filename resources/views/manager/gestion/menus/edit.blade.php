                    ...
                    <div class="w-full md:w-2/3 lg:w-3/4">
                        <div class="border-b border-gray-200 pb-4 mb-6">
                            <h3 class="text-xl font-semibold text-gray-700">
                                <i class="fas fa-edit text-orange-500 mr-2"></i>Modifier le menu {{ $menu->title }}
                            </h3>
                        </div>
                        
                        <form action="{{ route('menus.update', $menu->slug) }}" method="post" enctype="multipart/form-data" class="space-y-6">
                            @csrf
                            @method("PUT")
                            ...
                            <div class="mb-6">
                                ...
                                <label for="image" class="block text-sm font-medium text-gray-700 mb-2">Changer l'image (optionnel)</label>
                                <div class="mt-1 flex items-center space-x-5">
                                    <label class="relative cursor-pointer bg-white rounded-md font-medium text-orange-600 hover:text-orange-500 focus-within:outline-none">
                                        <span class="py-2 px-4 border border-gray-300 rounded-md shadow-sm">Choisir une nouvelle image</span>
                                        <input 
                                            type="file" 
                                            name="image" 
                                            id="image"
