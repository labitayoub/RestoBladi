                    ...
                    <div class="w-full md:w-2/3 lg:w-3/4">
                        <div class="border-b border-gray-200 pb-4 mb-6">
                            <h3 class="text-xl font-semibold text-gray-700">
                                <i class="fas fa-edit text-orange-500 mr-2"></i>Modifier le serveur
                            </h3>
                        </div>
                        
                        <form action="{{ route('waiters.update', $waiter->id) }}" method="post" class="space-y-6">
                            @csrf
                            @method("PUT")
                            ...
                            <div class="mb-6">
                                ...
                                <input
                                    ...
                                    value="{{ old('name', $waiter->user->name) }}"
                                    required
                                >
                                @error('name')
                            ...
                            <div class="mb-6">
                                ...
                                <input
                                    ...
                                    value="{{ old('email', $waiter->user->email) }}"
                                    required
                                >
                                @error('email')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div class="mb-6">
                                <label for="password" class="block text-sm font-medium text-gray-700 mb-2">Mot de passe (laissez vide pour ne pas modifier)</label>
                                <input
                                    type="password"
                                    name="password"
                                    id="password"
                            ...
                            <div class="mb-6">
                                ...
                                <input
                                    ...
                                    value="{{ old('phone_number', $waiter->phone_number) }}"
                                    required
                                >
                                @error('phone_number')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div class="mb-6">
                                ...
                                <select
                                    ...
                                    required
                                >
                                    <option value="active" {{ old('status', $waiter->status == 1 ? 'active' : '') == 'active' ? 'selected' : '' }}>Actif</option>
                                    <option value="inactive" {{ old('status', $waiter->status == 0 ? 'inactive' : '') == 'inactive' ? 'selected' : '' }}>Inactif</option>
                                </select>
                                @error('status')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
